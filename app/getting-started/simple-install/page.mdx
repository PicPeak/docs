...
**Putting PicPeak on the internet?** Any public server is probed by automated scanners within minutes. Before you share your first gallery link, read [Bots and Scanners](/deployment/bot-protection): a four-point checklist that takes ten minutes, plus an optional free shield in front of PicPeak. Installs that are only reachable inside your own network can skip it.
</Callout>
