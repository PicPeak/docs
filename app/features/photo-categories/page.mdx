...
<Callout type="info">
Folders are available on **stable from v3.132.0**, and on beta from v3.117.0-beta.0. See [Release Channels](/deployment/release-channels).
</Callout>
...
<Callout type="info">
Category ordering is available on **stable from v3.132.0**, and on beta before that. See [Release Channels](/deployment/release-channels).
</Callout>
