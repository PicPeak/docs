...
| External media reference mode and [folder watching](/features/external-media#watch-a-folder-for-new-files) (`EXTERNAL_MEDIA_ROOT`) | ✅ (always local) | ✅ (still local — not migrated) |
