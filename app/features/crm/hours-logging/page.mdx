...
The **Clients → Hours** index for "no customer selected" shows an aggregate view of every customer's unbilled hours + open monetary amount — useful for "what work is unbilled across all clients right now". This is post-PR-555 enhancement (see [feedback in PR #555](https://github.com/PicPeak/picpeak/pull/555#issuecomment-4572465673)); if you're on a pre-enhancement install, you'll see an empty state instead until you pick a customer.
