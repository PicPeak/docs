...
|---|---|---|
| Customer groups | Sort customers into groups, filter the customer list by them, change them in bulk, and target newsletters and workflows at them. | [Customer groups](/features/crm/customer-groups) |
...
See the [PR #555 discussion](https://github.com/PicPeak/picpeak/pull/555) for the design conversation if you want the full background.
