...
| Tax report | Per-period summary export for your tax return. | [Tax report](/features/crm/tax-report) |
...
All CRM admin settings live under **Settings → CRM** — see the [Admin Settings → CRM](/guides/admin-settings/crm) reference for every toggle and default.
