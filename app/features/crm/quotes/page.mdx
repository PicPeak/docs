...
When the per-customer flag is off, the customer detail page hides the "New quote" action and the service layer refuses `createQuote` calls for that customer (`CUSTOMER_FEATURE_DISABLED` / 409).
