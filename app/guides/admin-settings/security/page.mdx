...
This is available on stable from v3.47.0, and on beta from the build that ships PicPeak/picpeak#1271's fix. On earlier builds the sent-mail archive under Messages still shows gallery passwords in clear text; from those builds on they are masked there.
