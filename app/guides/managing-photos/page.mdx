...
Categories can also carry a cover photo, block downloads for their photos, and be reordered per gallery. See [Photo Categories & Folders](/features/photo-categories) for all of it.
